...
<html>
  ...
  <body>
    ...
    <div id="nav-menu">
      <a href="../index.php" class="<?php if($currentPage =='dashboard.php'){echo 'active';}?>"><div class="icon-nav"><i class="fa fa-undo" aria-hidden="true"></i></div><span >Backup Monitor</span></a>
      <a href="dupindex.php"><div class="icon-nav"><i class="fa fa-clone" aria-hidden="true"></i></div><span>Duplicate Index</span></a>
      <a href="#" class="active"><div class="icon-nav"><i class="fa fa-database" aria-hidden="true"></i></div><span>Databases</span></a>
  ...
  <div id="content-container">
    ...
    <div style="margin-top:80px;" class="container">
      <div style="margin-left:15px;" class="row">
        <h1>DBA Database List Dashboard</h1>
		<h3>Choose Database</h3>
			<form id="dname" action="#" method="POST">
				<select name="db_name" id="db_name">
					<option value="">------choose-----</option>
						<?php
						$sql1="SELECT distinct dbname FROM db_info ORDER BY dbname";
